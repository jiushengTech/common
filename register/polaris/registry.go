...
type options struct {
	...
	// optional, addr for polaris
	Addr string

	// optional, Location for polaris
...
// WithAddr with Addr option.
func WithAddr(addr string) Option {
	return func(o *options) { o.Addr = addr }
}

// WithLocation with Location option.
func WithLocation(Location model.Location) Option {
